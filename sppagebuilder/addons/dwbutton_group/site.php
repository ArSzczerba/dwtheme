...
class SppagebuilderAddonDWButton_group extends SppagebuilderAddons {
                ...
                if ($value->title || $value->icon) {
                    ...
                    if ($icon_position == 'left') {
                        ...
                        $text = ($icon) ? $text . ' <i class="fa ' . $icon . '" aria-hidden="true"></i>' : $text;
										...
										if($type == "cta"){
											$output .= '<a' . $attribs . ' class="sppb-btn btn-'.$ctacolor.' ' . $class . '"><span class="text">' . $text . '</span><span class="line -right"></span><span class="line -top"></span><span class="line -left"></span><span class="line -bottom"></span></a>';
										} else {
    ...
    public static function getTemplate() {
		...
		<style type="text/css">
			...
			<# _.each(data.sp_dwbutton_group_item, function(button, key){ #>
				<#
