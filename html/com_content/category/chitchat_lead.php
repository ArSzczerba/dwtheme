...
<?php if($params->get('show_title')){ ?>
	<div class="overlay">
		<div>
			<?php echo JLayoutHelper::render('joomla.content.chitchat_default_item_title', $this->item); ?>
		</div>
		<?php if ($info == 0 && $params->get('show_tags', 1) && !empty($this->item->tags->itemTags)) : ?>
			<div class="d-flex justify-content-between align-items-center">
				<?php echo JLayoutHelper::render('joomla.content.chitchat-tags', $this->item->tags->itemTags); ?>

				<?php if($this->item->jcfields['8']->value == 'text'){ ?>
					<img class="type-icon" src="<?php echo JURI::base(); ?>images/blog/text-icon.png" />
				<?php } elseif($this->item->jcfields['8']->value == 'video') {?>
					<img class="type-icon" src="<?php echo JURI::base(); ?>images/blog/video-icon.png" />
				<?php } ?>
			</div>
		<?php endif; ?>
