...
?>
<?php if (JRequest::getInt('start')) $paged = true; else $paged = false; ?>
...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
	...
	<?php $leadingcount = 0; ?>
	<?php if (!empty($this->lead_items) && !$paged) : ?>
	...
	<?php if (!empty($this->lead_items) && $paged) : ?>
			<?php $this->intro_items = array_merge($this->lead_items, $this->intro_items);?>
	<?php endif; ?>
	...
	<div class="row">
		...
		<?php
				$modules  = JModuleHelper::getModules("blogright");
				$document = JFactory::getDocument();
				$attribs  = array();
				$attribs['style'] = 'xhtml';
			?>
