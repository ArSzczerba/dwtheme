...
<?php if($this->item->isBlog){ ?>
	<div class="chit-chat-top container pt-5 pb-3 d-flex justify-content-between align-items-center">
		...
		<p><span>Share this post:</span>
			...
			<a class="mr-3" onClick="window.open('https://www.facebook.com/sharer.php?u=<?php echo $current_url; ?>,'Facebook','width=600,height=300,left='+(screen.availWidth/2-300)+',top='+(screen.availHeight/2-150)+''); return false;" href="https://www.facebook.com/sharer.php?u=<?php echo $current_url; ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a>
			<a class="mr-3" onClick="window.open('https://plus.google.com/share?url=<?php echo $current_url; ?>','Google plus','width=585,height=666,left='+(screen.availWidth/2-292)+',top='+(screen.availHeight/2-333)+''); return false;" href="https://plus.google.com/share?url=<?php echo $current_url; ?>" ><i class="fa fa-google-plus" aria-hidden="true"></i></a>
			<a class="mr-3" onClick="window.open('http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $current_url; ?>','Linkedin','width=585,height=666,left='+(screen.availWidth/2-292)+',top='+(screen.availHeight/2-333)+''); return false;" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $current_url; ?>" ><i class="fa fa-linkedin" aria-hidden="true"></i></a>
